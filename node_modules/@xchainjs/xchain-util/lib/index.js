...
const AvalancheChain = exports.Chain.Avalanche;
...
const AVAXChain = exports.Chain.Avax;
/**
...
const isEnabledChain = (chain) => chain.includes(chain);
/**
...
const chainToString = Object.assign((chainId) => {
    ...
    [exports.Chain.Avalanche]: 'Avalanche',
 ...
 */
const isBtcChain = (chain) => eqChain(chain, BTCChain);
/**
 * Check whether chain is LTC chain
 */
const isLtcChain = (chain) => eqChain(chain, LTCChain);
/**
 * Check whether chain is THOR chain
 */
const isThorChain = (chain) => eqChain(chain, THORChain);
/**
 * Check whether chain is BNB chain
 */
const isBnbChain = (chain) => eqChain(chain, BNBChain);
/**
 * Check whether chain is ETH chain
 */
const isEthChain = (chain) => eqChain(chain, ETHChain);
/**
 * Check whether chain is BCH chain
 */
const isBchChain = (chain) => eqChain(chain, BCHChain);
/**
 * Check whether chain is DOGE chain
 */
const isDogeChain = (chain) => eqChain(chain, DOGEChain);
 ...
 *
 */
const AssetAVAX = { chain: exports.Chain.Avalanche, symbol: 'AVAX', ticker: 'AVAX', synth: false };
/**
...
exports.AvalancheChain = AvalancheChain;
...
exports.isBchChain = isBchChain;
exports.isBigNumberValue = isBigNumberValue;
exports.isBnbChain = isBnbChain;
exports.isBtcChain = isBtcChain;
exports.isChain = isChain;
exports.isDogeChain = isDogeChain;
exports.isEnabledChain = isEnabledChain;
exports.isEthChain = isEthChain;
exports.isLtcChain = isLtcChain;
exports.isSynthAsset = isSynthAsset;
exports.isThorChain = isThorChain;
